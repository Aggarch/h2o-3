...
public class DetectDuplicatesTaskTest {
    ...
    public void testSimpleDuplicateDetection() {
        try {
            ...
            assertEquals(0, duplicatedRow.getStartRow());
            assertEquals(1, duplicatedRow.getEndRow());
    ...
    public void testTwoDuplicatesOneChunk() {
        try {
            ...
            assertEquals(0, firstDuplicatedRow.getStartRow());
            assertEquals(1, firstDuplicatedRow.getEndRow());
            assertEquals(0, firstDuplicatedRow.getChunkId());

            final DuplicatedRow secondDuplicatedRow = duplicatesFound[1];
            assertEquals(2, secondDuplicatedRow.getStartRow());
            assertEquals(3, secondDuplicatedRow.getEndRow());
    ...
    public void testWholeChunkDuplicatedRow() {
        try {
            ...
            final DuplicatedRow duplicatedRow = duplicatesFound[0];
            assertEquals(0, duplicatedRow.getStartRow());
            assertEquals(2, duplicatedRow.getEndRow());
            assertEquals(0, duplicatedRow.getChunkId());
    ...
    public void testCrossChunkBoundaries() {
        try {
            ...
            final DuplicatedRow firstDuplicatedRow = duplicatesFound[0];
            assertEquals(0, firstDuplicatedRow.getStartRow());
            assertEquals(2, firstDuplicatedRow.getEndRow());
            assertEquals(0, firstDuplicatedRow.getChunkId());

            final DuplicatedRow secondDuplicatedRow = duplicatesFound[1];
            assertEquals(0, secondDuplicatedRow.getStartRow());
            assertEquals(1, secondDuplicatedRow.getEndRow());
    ...
    public void testCrossChunkBoundariesVariousSecondChunk() {
        try {
            ...
            assertEquals(2, thirdDuplicatedRow.getStartRow());
            assertEquals(3, thirdDuplicatedRow.getEndRow());
